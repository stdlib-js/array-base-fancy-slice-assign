...
```javascript
import sliceAssign from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-fancy-slice-assign@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-base-fancy-slice-assign/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/array-base-fancy-slice-assign/actions/workflows/test.yml?query=branch:v0.2.2
